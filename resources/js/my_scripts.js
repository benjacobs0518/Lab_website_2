...
function loadStatsPage(){
		...
		{
			if(parseInt(table.rows[row_counter].cells[2].innerHTML) >
				 parseInt(table.rows[row_counter].cells[3].innerHTML)){
				table.rows[row_counter].cells[4].innerHTML = "Buffs";
				wins++; //Implement
			}

			else if(parseInt(table.rows[row_counter].cells[2].innerHTML) <
				 			parseInt(table.rows[row_counter].cells[3].innerHTML)){
...
function loadPlayersPage(){
	...
	var name ="";
		for(var i = 0; i < players.length; i++) {
			...
			name = name + "<a class='dropdown-item' href='#' onclick='switchPlayers("+ i +")'>" + player + "</a>"
	}
...
function switchPlayers(playerNum){
	...
	var avgcat=Math.floor(players[playerNum].receiving_yards/players[playerNum].games_played);

	document.getElementById('avg_p_yards').innerHTML = avgpass;
	document.getElementById('avg_r_yards').innerHTML = avgrush;
	document.getElementById('avg_rec_yards').innerHTML = avgcat;
